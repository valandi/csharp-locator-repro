...
public class AcmeBankTests
{
    ...
    public async Task LogIntoBankAccount()
    {
        ...
        // Load the login page.
        await Page.GotoAsync("https://www.applitools.com");


        // Verify the full login page loaded correctly.
        Eyes.Check(Target.Window().Fully().WithName("Login page")
            .Layout(
                Page.Locator("#post-8 > div:nth-child(2) > div > div.block.icon-grid.theme-.pt-none.justify-content-center > div:nth-child(1) > img")
            )
        );
